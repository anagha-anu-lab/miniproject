                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="service-contents" name="service-contents" class="form-control"><?php echo set_value('service-contents')?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                            ...
                            <div class="card-footer">
                                <div class="form-group text-right">
                                    ...
                                    <button class="btn btn-success"><i class="fas fa-plus mr-1"></i> Create Service</button>
                                </div>
                            </div>
                        </div>
                    </form>
