                    ...
                    <form enctype="multipart/form-data"  method="POST" action="<?php anchor_to(SERVICE_CONTROLLER . '/editservice/' . $service['id']) ?>">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="service-contents">Content <span class="text-danger">*</span></label>
                                    <?php echo form_error('service-contents', '<br><span class="text-danger">', '</span>'); ?>
                                    <textarea id="service-contents" name="service-contents" class="form-control"><?php echo esc(set_value('service-contents', $service['description']), true)?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
