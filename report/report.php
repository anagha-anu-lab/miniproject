        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    <li class="nav-home">
                        <a href="<?php anchor_to(REPORT_CONTROLLER . '/report') ?>">
                ...
                <div class="col-md-12">
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Monthly Users</p>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title float-left">Monthly Service Booking Count</div>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title float-left">Recent Bookings</div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped mt-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title float-left"> Recent Registered Clients</div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped mt-3">
