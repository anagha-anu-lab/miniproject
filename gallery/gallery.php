                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?php anchor_to(GALLERY_CONTROLLER . '/addImg') ?>" class="btn btn-primary float-right"><i class="fas fa-plus mr-2"></i> Add Product</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        <?php if(!$listGalleryWidCat){?>
                                            <tr>
                                                <td colspan="6" class="text-center"><h4 class="text-muted">No Product Found</h4></td>
                                            </tr>
                                        <?php } else{?>
                                        <?php $i = 1; foreach ($listGalleryWidCat as $listGall){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo esc($listGall['price'], true) ?></td>
                                                <td class="text-right">
