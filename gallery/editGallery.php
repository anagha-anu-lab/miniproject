                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="image-content" name="image-content" class="form-control"><?php echo esc(set_value('image-content', $gallery['imgDetails']), true)?></textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" id="image-price" name="image-price" value="<?php echo esc(set_value('image-price', $gallery['price']), true)?>">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="categoryId" id="" class="form-control custom-select">
                                                <?php foreach($categories as $gCat){ ?>
                                                    <option value="<?php echo esc($gCat['id'], true)?>"<?php echo ($gCat['id'] == $gallery['catId']) ? 'selected' : '' ?>><?php echo esc($gCat['cName'], true)?> </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
