				  ...
				  <form action="<?php anchor_to(ADMINBLOG_CONTROLLER . '/add_post') ?>" method="POST" enctype="multipart/form-data">
					<div class="card-body">
						<div class="row">
                           ...
                           <label for="title">Offer Name <span class="text-danger">*</span></label>
                           <?php echo form_error('title', '<br><span class="text-danger">', '</span>'); ?>
                           <input class="form-control" type="text" id="title" name="title" placeholder="Enter Offer Name" value="<?php echo esc(set_value('title'), true)?>">
                        </div>
                        <div class="form-group">
                           <label for="description">Description <span class="text-danger">*</span></label>
                           <?php echo form_error('description', '<br><span class="text-danger">', '</span>'); ?>
                           <textarea id="description" name="description" class="form-control" placeholder="Choose Offer Short Description"><?php echo esc(set_value('description'), true)?></textarea>
                        </div>
                        <div class="form-group">
                           <label for="price">Price <span class="text-danger">*</span></label>
                           <?php echo form_error('price', '<br><span class="text-danger">', '</span>'); ?>
                           <input class="form-control" type="number" id="price" name="price" placeholder="Enter Price" value="<?php echo esc(set_value('price'), true)?>">
                        </div>
								<div class="form-group">
					...
					<div class="card-action">
						...
						<button type="submit" class="btn btn-success"><i class="fas fa-check mr-1"></i> Add Offers</button>
					</div>
				  </form>
               </div>
            </div>
