                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title float-left">Offers</div>
                            <a href="<?php anchor_to(ADMINBLOG_CONTROLLER . '/add_post') ?>" class="btn btn-primary float-right"><i class="fas fa-plus mr-2"></i> Add Offers</a>
                            <span class="custom-control custom-switch mt-2 mr-3 float-right">
                                ...
                                <label class="custom-control-label lh-cs mb-0" for="blogStatus">Show Offer</label>
                                </form> -->
                            </span>
                                ...
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo esc($blogList['price'], true) ?></td>
