...
<div class="main-panel">
    <div class="container">
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form enctype="multipart/form-data"  method="POST" action="<?php anchor_to(ATTENDANCE_CONTROLLER . '/addattendance') ?>">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="agent">Name Of Employee <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control dateTimePickerInput" id="datepicker" type="text" id="datepicker" name="attendance-starts" placeholder="Type: when your attendance starts" value="<?php echo set_value('attendance-starts')?>">
                                </div>
                            </div>
                            <div class="card-footer">
                                <div class="form-group text-right">
                                    <input type="hidden" name="submit" value="Submit">
                                    <a href="<?php anchor_to(ATTENDANCE_CONTROLLER . '/attendances'); ?>" class="btn btn-danger text-white mr-4"><i class="fas fa-arrow-left mr-1"></i> Back</a>
                                    <button class="btn btn-success"><i class="fas fa-plus mr-1"></i> Mark Attendance</button>
                                </div>
                            </div>
                        </div>
                    </form>
