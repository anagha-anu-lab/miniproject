                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title float-left">Survey Question</div>
                                ...
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php anchor_to(SURVEY_CONTROLLER . '/qstnEdit/' . $gCat['id']) ?>" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-link btn-primary btn-lg">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <button type="button" class="btn btn-link btn-danger qstnDelete" data-toggle="tooltip" data-placement="top" title="Delete" value="<?php echo esc($gCat['id'], true) ?>"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                        <?php }
                                        } else{
